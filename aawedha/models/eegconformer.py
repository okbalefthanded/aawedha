# Implements EEG Conformer model from:
# Song, Y., Zheng, Q., Liu, B., Gao, X.: EEG Conformer: Convolutional Transformer for 
# EEG Decoding and Visualization. IEEE Trans. Neural Syst. Rehabil. Eng. 
...
class Conformer(nn.Module):
    ...
    def forward(self, x):
        ...
        x, out = self.classificationHead(x)
        return out