...
def PodNet(nb_classes, Chans=64, Samples=128,
    ...
    #
    block1 = Conv2D(100, (10, 30), padding='same',
    ...
    #
    block2 = Conv1D(100, kernel_size=30, padding='same',  strides=4,
    ...
    #
    block3 = Conv1D(100, kernel_size=30, padding='same',  strides=4,
    ...
    #
    block4 = Conv1D(100, kernel_size=30, padding='same',  strides=4,
    ...
    #
    block5 = Conv1D(100, kernel_size=30, padding='same',  strides=4,
