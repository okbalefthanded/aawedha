# Implements WASAM (Weight-Averaged Sharpness-Aware Minimization) (SWA + SAM) [1]
# code taken from : https://github.com/JeanKaddour/WASAM
# [1] J. Kaddour, L. Liu, R. Silva, and M. J. Kusner, When Do Flat Minima Optimizers Work? 
# arXiv, 2022. doi: 10.48550/ARXIV.2202.00661.
import warnings
...
class WASAM(torch.optim.Optimizer):
    def __init__(self, params: Params, base_optimizer: torch.optim.Optimizer,
                 rho: float = 0.05, adaptive: bool = False, **kwargs,):
