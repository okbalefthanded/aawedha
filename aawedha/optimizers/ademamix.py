# Taken from official code repo : https://github.com/apple/ml-ademamix/blob/main/pytorch/ademamix.py
# Implements Ademamix optimizer published in:
# Pagliardini, Matteo, Pierre Ablin, and David Grangier. 
