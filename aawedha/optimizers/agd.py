# taken from official code repo : https://github.com/jxbz/agd/
# Implements the Automatic Gradient Descent (AGD) optimizer published in:
# Bernstein J, Mingard C, Huang K, Azizan N, Yue Y. Automatic Gradient Descent: 
# Deep Learning without Hyperparameters. 2023; 
# Available from: http://arxiv.org/abs/2304.05187
import math
import torch
